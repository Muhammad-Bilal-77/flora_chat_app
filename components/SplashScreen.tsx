          ...
          <View style={styles.svgContainer}>
            ...
            <Animated.View style={[styles.leafTopLayer, leafTopStyle]}>
              <Svg width={192} height={192} viewBox="0 0 200 200">
                <G>
                  <Path
                    d="M100 80 C100 80 80 60 100 40 C120 60 100 80 100 80Z"
                    fill="#4ade80"
                  />
                  <Path
                    d="M100 80 L100 60"
            ...
            <Animated.View style={[styles.leafRightLayer, leafRightStyle]}>
              <Svg width={192} height={192} viewBox="0 0 200 200">
                <G>
                  <Path
                    d="M125 105 C125 105 145 95 150 75 C125 80 125 105 125 105Z"
                    fill="#86efac"
                  />
                  <Path
                    d="M125 105 C125 105 130 90 140 80"
                    stroke="#16a34a"
                    strokeLinecap="round"
                    strokeWidth={1}
                    opacity={0.3}
            ...
            <Animated.View style={[styles.leafLeftLayer, leafLeftStyle]}>
              <Svg width={192} height={192} viewBox="0 0 200 200">
                <G>
                  <Path
                    d="M70 85 C70 85 50 75 45 55 C70 60 70 85 70 85Z"
                    fill="#22c55e"
                  />
                  <Path
                    d="M70 85 C70 85 65 70 55 60"
                    stroke="#14532d"
                    strokeLinecap="round"
                    strokeWidth={1}
                    opacity={0.3}
